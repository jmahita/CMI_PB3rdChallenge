...
df1 = pd.read_csv(r'ch2024_IgG_PT_specimen_2020_21_22_combined_long.csv')
#df1b = df1[[" Age"," Infancy Vaccine"," Ethnicity"," Race"," Biological Sex",'IgG_PT_day0',"Fold Change (day 0 vs day 14)"]]
df1b = df1[[" Age"," Infancy Vaccine"," Ethnicity",'IgG_PT_day0',"Fold Change (day 0 vs day 14)"]]
...
df2b = df2[[" Age"," Infancy Vaccine"," Ethnicity",'IgG_PT_day0']]
#X_test = df2b.iloc[:,:1]
X_test = df2b.iloc[:,:]
#y_test = df2b.iloc[:, -1]
